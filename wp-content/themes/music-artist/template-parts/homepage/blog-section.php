...
$blog_section_title = $music_artist_options['blog_title'];
$blog_desc = $music_artist_options['blog_desc'];
$blog_category = $music_artist_options['blog_category'];
$content_length = '100';
if($blog_show) {
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="blog-wrap">
                                  ...
                                  <figcaption>
                                    ...
                                    <p><?php echo wp_kses_post(music_artist_get_excerpt($recent_query->post->ID, $content_length)); ?></p>
